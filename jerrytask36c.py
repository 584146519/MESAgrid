...
def mkmesadir2D(a, b, name='grid', start1=0, step1=1, start2=0, step2=1):#创建二维网格文件夹
    ...
    for i in range(a):
        for j in range(b):
            dirname = f'{gridname}_{start1+step1*i:.{decimal1}f}_{start2+step2*j:.{decimal2}f}' 
...
if __name__ == "__main__":
    ...
    # 排除列表
    exclude_functions = ['create_gui_for_function','timescaleo','timescale','replaceline2','getvalue','glob','update_value_in_file','count_decimal_places','版本变化','process_HR']
